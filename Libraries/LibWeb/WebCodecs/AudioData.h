...
struct AudioDataCopyToOptions {
    WebIDL::UnsignedLongLong plane_index;
...
class AudioData final : public Bindings::PlatformObject
    ...
    WebIDL::ExceptionOr<void> copy_to(GC::Root<WebIDL::BufferSource>& destination, AudioDataCopyToOptions const&);
    GC::Ref<AudioData> clone();
    void close();
